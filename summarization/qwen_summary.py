...
class QwenSummarizer:
    ...
    def build_track_profile_prompt(self, track_id, segments, track_metadata=None, allowed_objects=None):
        ...
        return (
            ...
            "Treat action-classifier labels as weak hints, not facts; ignore low-confidence or visually unsupported actions.\n"
    ...
    def build_track_prompt(self, track_id, segments, track_metadata=None):
        ...
        return (
            ...
            "Treat action-classifier labels as weak hints, not facts; avoid repeating unusual actions unless confidence is high.\n"
    ...
    def build_scene_prompt(self, event_log, track_payload):
        ...
        return (
            ...
            "Treat action-classifier labels as weak hints and avoid unusual low-confidence actions.\n"
    ...
    def build_video_scene_prompt(self, event_log, track_payload):
        ...
        return (
            ...
            "Treat action-classifier labels as weak hints, not facts; do not repeat odd labels unless they are clearly supported.\n"
    ...
    def build_qa_prompt(self, question, context_docs, conversation_history=None, has_visual_evidence=False):
        ...
        return (
            ...
            "Use conversation history only for resolving references, not as evidence. Treat action-classifier labels "
            "as weak hints; do not mention odd actions unless the retrieved keyframes or context clearly support them.\n"
...
class QwenVLSummarizer:
    ...
    def build_track_profile_prompt(self, track_id, segments, track_metadata=None, allowed_objects=None):
        ...
        return (
            ...
            "Treat action-classifier labels as weak hints, not facts; ignore them when the person crops do not support them.\n"
            "Use only allowed_objects labels for carried_objects.\n"
            "Return ONLY valid JSON with this schema:\n"
            "{\n"
            '  "track_id": int,\n'
    ...
    def build_track_prompt(self, track_id, segments, track_metadata=None):
        ...
        return (
            ...
            "Treat action-classifier labels as weak hints, not facts; avoid repeating unusual actions unless the images support them.\n"
    ...
    def build_video_scene_prompt(self, event_log, track_payload):
        ...
        return (
            ...
            "Treat action-classifier labels as weak hints, not facts; do not repeat odd labels unless sampled frames support them.\n"
            "Write 2 short paragraphs that summarize the overall scene, main people, object interactions, and notable changes.\n"
    ...
    def build_qa_prompt(self, question, context_docs, conversation_history=None, has_visual_evidence=False):
        ...
        return (
            ...
            "adjacent 5-second windows before answering specific-time questions.\n"
            "Use conversation history only for resolving references, not as evidence. Treat action-classifier labels "
            "as weak hints; do not mention odd actions unless the keyframes or retrieved context clearly support them.\n"
            f"{visual_instruction}"
            "If the context is insufficient, say so explicitly.\n"
            "Answer in 3-6 sentences and cite track IDs and time ranges when available.\n\n"
            f"Conversation history:\n{_format_chat_history(conversation_history)}\n\n"
